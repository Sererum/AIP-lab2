...
OBJECTS = build/release/lab2.o build/release/my_string.o build/release/base_file.o build/release/file32.o build/release/rle_file.o
...
DEBUG_OBJECTS = build/debug/debug_lab2.o build/debug/debug_my_string.o build/debug/debug_base_file.o build/debug/debug_file32.o build/debug/debug_rle_file.o
